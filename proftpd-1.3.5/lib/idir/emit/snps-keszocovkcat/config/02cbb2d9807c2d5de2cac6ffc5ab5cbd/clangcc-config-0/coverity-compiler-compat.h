...
#if __COVERITY__
#if !defined(COVERITY_COMPAT_8cceaa42bd01cd24b0ea5fdfc7a6e934)
#define COVERITY_COMPAT_8cceaa42bd01cd24b0ea5fdfc7a6e934

/*
  Copyright (c) 2013,2015, Synopsys, Inc. All rights reserved worldwide.
...
/* #if (__cov_clang_version_lt(9, 0) || __coverity_assume_xcode__ ) */
#if (__cov_clang_version_lt(9, 0) ) /* { */

/* Removed in Clang 9.0 but kept in apple clang 11.4 but now also removed { */
...
#endif /* COVERITY_COMPAT_8cceaa42bd01cd24b0ea5fdfc7a6e934 */
#endif /* __COVERITY__ */
