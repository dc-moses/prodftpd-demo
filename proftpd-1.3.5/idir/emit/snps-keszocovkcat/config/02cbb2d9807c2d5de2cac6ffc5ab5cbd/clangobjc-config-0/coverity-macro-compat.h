...
#endif
#if !(defined(OBJC_ZEROCOST_EXCEPTIONS) || defined(__coverity_undefine_OBJC_ZEROCOST_EXCEPTIONS))
...
#define __MMX__ 1
#endif
#if !(defined(__NEXT_RUNTIME__) || defined(__coverity_undefine___NEXT_RUNTIME__))
#define __NEXT_RUNTIME__ 1
#endif
#if !(defined(__NO_INLINE__) || defined(__coverity_undefine___NO_INLINE__))
#define __NO_INLINE__ 1
#endif
#if !(defined(__NO_MATH_INLINES) || defined(__coverity_undefine___NO_MATH_INLINES))
#define __NO_MATH_INLINES 1
#endif
#if !(defined(__OBJC2__) || defined(__coverity_undefine___OBJC2__))
#define __OBJC2__ 1
#endif
